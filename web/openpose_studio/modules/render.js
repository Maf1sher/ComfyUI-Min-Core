...
const RENDER_STYLE_SYNC_URL = "/mincore/openpose/render_style";

const RENDER_STYLE_KEYS = {
	version: "mincore_openpose_editor.renderer.version",
	body: {
		lineWidth: "mincore_openpose_editor.renderer.body.line_width",
		keypointColor: "mincore_openpose_editor.renderer.body.keypoint_color",
		keypointRadius: "mincore_openpose_editor.renderer.body.keypoint_radius"
	},
	hands: {
		lineWidth: "mincore_openpose_editor.renderer.hands.line_width",
		keypointColor: "mincore_openpose_editor.renderer.hands.keypoint_color",
		keypointRadius: "mincore_openpose_editor.renderer.hands.keypoint_radius"
	},
	face: {
		lineWidth: "mincore_openpose_editor.renderer.face.line_width",
		keypointColor: "mincore_openpose_editor.renderer.face.keypoint_color",
		keypointRadius: "mincore_openpose_editor.renderer.face.keypoint_radius"
	}
};
