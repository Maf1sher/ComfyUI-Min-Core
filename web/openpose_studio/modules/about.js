...
export const ABOUT_INFO = {
    ...
    paypalQrUrl: "/mincore/openpose/assets/qr-paypal.svg",
    usdcQrUrl: "/mincore/openpose/assets/qr-usdc.svg",
                        ...
                        <div class="openpose-about-row-title openpose-support-titlebar">
                            ...
                            <div class="openpose-support-badges">
                                <a class="openpose-support-badge-link openpose-support-badge" href="${ABOUT_INFO.kofiUrl}" target="_blank" rel="noopener noreferrer" title="${t("donate.tooltip.kofi")}">
                                    <img class="openpose-support-badge-img" src="/mincore/openpose/assets/badge_kofi.svg" alt="${t("donate.tooltip.kofi")}" title="${t("donate.tooltip.kofi")}" />
                                </a>
                                <a class="openpose-support-badge-link openpose-support-badge" href="${ABOUT_INFO.paypalUrl}" target="_blank" rel="noopener noreferrer" title="${t("donate.tooltip.paypal")}">
                                    <img class="openpose-support-badge-img" src="/mincore/openpose/assets/badge_paypal.svg" alt="${t("donate.tooltip.paypal")}" title="${t("donate.tooltip.paypal")}" />
                                </a>
                                <a class="openpose-support-badge-link openpose-support-badge" href="#openpose-usdc" title="${t("donate.tooltip.usdc")}">
                                    <img class="openpose-support-badge-img" src="/mincore/openpose/assets/badge_usdc.svg" alt="${t("donate.tooltip.usdc")}" title="${t("donate.tooltip.usdc")}" />
                                </a>
                            </div>
                        </div>
...
function fetchOpenPoseEditorVersion() {
    return (async () => {
        try {
            ...
            const response = await fetchFn("/mincore/openpose/version", {
                method: "GET",
                cache: "no-store"
            });
